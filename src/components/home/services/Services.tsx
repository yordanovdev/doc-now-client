...
export const Services = () => {
    return (
        ...
        <div className="">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 md:w-188 xl:w-auto xl:grid-cols-5 gap-6 max-w-305 mx-auto justify-items-center xl:max-w-none xl:mx-0 xl:flex xl:justify-between">
                <Service
...
const Service = (props: ServiceProps) => {
    return <div className="w-full h-114.25 sm:h-fit md:w-56.25 md:h-131">
        {props.image && <img src={props.image} alt={props.title} className="rounded-3xl w-full h-61.5 md:h-[341.5px] mb-6 object-cover object-[25%_25%]" />}
