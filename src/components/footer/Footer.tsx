...
export const Footer = () => {
    return <div className="px-4 relative md:px-6 xl:px-10 py-6 overflow-hidden max-w-305 max-md:max-w-md mx-auto">
        <div className="max-w-305 max-md:max-w-md md:w-188 mb-10 xl:w-full mx-auto flex flex-col items-center max-md:items-start gap-8">
            ...
            <div className="w-full flex flex-col gap-3 items-center md:flex-row md:space-x-4 md:gap-0 justify-center">
                <Button variant={"filled"} className="w-full md:w-auto">
                    <Typography variant={"link"}  as="p" className="font-transformaMix text-center hover:text-inherit">
                        Запази Час
                    </Typography>
                </Button>
